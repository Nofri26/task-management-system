...
export default function ModalForm({ show, onClose, task = null, token, fetchTasks, currentPage }) {
    ...
    <Modal show={show} onClose={onClose}>
      <form onSubmit={handleSubmit} className="p-6">
        <div className="flex justify-between">
          <h2 className="text-xl mb-4 font-bold">{data.id ? "Update Task" : "Tambah Tasklist"}</h2>
          <i onClick={onClose} className="bi bi-x-lg cursor-pointer"></i>
        </div>
        <div className="mb-4">
        ...
        <div className="flex justify-end gap-4">
          <button type="button" onClick={onClose} className="px-4 py-2 text-gray-500 rounded-md hover:underline">
            Kembali
          </button>
